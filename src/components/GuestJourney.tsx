...
import { Calendar, QrCode, Ticket, Music, UtensilsCrossed, Users, Heart, ArrowRight } from "lucide-react";
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="relative mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-7 gap-6 lg:gap-4">
            ...
            return <div key={step.id} className="relative group" onMouseEnter={() => setActiveStep(step.id)} onMouseLeave={() => setActiveStep(null)}>
                  {/* Connection Arrow for Mobile/Tablet */}
                  {index < journeySteps.length - 1 && <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 lg:hidden">
                  ...
                  <Card className={`
                      ...
                      ${activeStep === step.id ? 'border-primary shadow-2xl scale-105 bg-gradient-to-br from-primary/5 to-secondary/5' : 'border-border hover:border-primary/50 hover:shadow-xl'}
                    `} style={{
                background: activeStep === step.id ? step.bgPattern : 'transparent'
                    ...
                    <div className={`
                      ...
                      ${activeStep === step.id ? 'bg-gradient-to-r ' + step.color + ' text-white shadow-lg' : 'bg-muted text-muted-foreground'}
                    `}>
                      {step.id}
                    </div>
